...
if __name__ == "__main__":
    ...
    parser.add_argument("--batch_size", default=6, type=int, help=" bs, 17 服务器最大可以跑 4 ")
    parser.add_argument("--learning_rate", default=1e-5, type=float, help=" 学习率 for Adam.")
    parser.add_argument("--train_path", default='./data/text/train.txt', type=str, help="训练集路径")
    parser.add_argument("--dev_path", default='./data/text/dev.txt', type=str, help="The path of dev set.")
    parser.add_argument("--save_dir", default='./checkpoint', type=str, help="训练结果保存路径")
    parser.add_argument("--max_seq_len", default=512, type=int, help=" 最大序列长度（文本） ")
    parser.add_argument("--num_epochs", default=100, type=int, help=" epoch ")
    parser.add_argument("--seed", default=1000, type=int, help=" 种子数 ")
    parser.add_argument("--logging_steps", default=10, type=int, help=" 记录间隔 ")
    parser.add_argument("--valid_steps", default=100, type=int, help=" 验证间隔 ")
    parser.add_argument('--device', choices=['cpu', 'gpu'], default="gpu", help=" 设备 ")
    parser.add_argument("--model", choices=["uie-base", "uie-tiny", "uie-medium", "uie-mini", "uie-micro", "uie-nano"], default="uie-base", type=str, help="基模型")
    parser.add_argument("--init_from_ckpt", default=None, type=str, help=" 初始化模型参数 ")
